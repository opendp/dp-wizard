...
Generated by DP Wizard v{__version__} (https://github.com/opendp/dp-wizard) on {now}.
    ...
    def get_groups_with_keys(self) -> dict[ColumnName, list[str]]:
        # TODO: No... It's possible the user supplied keys for a grouping column,
        # so it's in the app_state,
        # but then removed that grouping column.
        # This needs to be handled upstream, where is object is created.
