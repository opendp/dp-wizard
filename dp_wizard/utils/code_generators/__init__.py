...
class AnalysisPlan(NamedTuple):
    ...
    >>> print(plan.to_note())
    This demonstrates how to calculate ... Generated by DP Wizard ...
    """
    ...
    def to_note(self) -> str:
        ...
        return (
            f"This demonstrates how to calculate {self}. "
            f"Generated by DP Wizard v{__version__} "
            f"(https://github.com/opendp/dp-wizard) on {now}."
        )
