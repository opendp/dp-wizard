...
expected_urls = [
    ...
    "https://docs.opendp.org/en/stable/api/python/opendp.extras.polars.html#opendp.extras.polars.LazyFrameQuery.summarize",
    "https://docs.opendp.org/en/stable/api/python/opendp.extras.mbi.html#opendp.extras.mbi.ContingencyTable.synthesize",
    "https://docs.opendp.org/en/stable/api/python/opendp.extras.mbi.html#opendp.extras.mbi.ContingencyTable.project_melted",
]
